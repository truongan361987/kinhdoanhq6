...
<div class="ho-kinh-doanh-index">
    <div id="ajaxCrudDatatable">
        ...
        GridView::widget([
            ...
            'toolbar' => [
                ['content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', Yii::$app->urlManager->createUrl('hokinhdoanh/create'), ['class' => 'btn btn-success', 'title' => 'Thêm mới']) .
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> Danh sách Hộ kinh doanh',
                'after' => false,
            ]
        ])
        ?>
