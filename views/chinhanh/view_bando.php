            ...
            <div class=" tab-pane active" id="thongtinchung">
                <div class="col-md-12 form-group" >
                    <table class="table table-responsive table-bordered table-striped">
                        ...
                        <tr>
                            <th>Địa chỉ</th>
                            <td colspan="3"><?= (($model['doanhnghiep']->so_nha == NULL) ? '' : $model['doanhnghiep']->so_nha . ', ') . (($model['doanhnghiep']->ten_duong == NULL) ? '' : $model['doanhnghiep']->ten_duong . ', ') . (($model['doanhnghiep']->ten_phuong == NULL) ? '' : $model['doanhnghiep']->ten_phuong . ', ') . $model['doanhnghiep']->ten_quan ?></td>
                        </tr>
                        <tr>
                            <th>Giấy phép số</th>
...
<div class="modal-footer">
    ...
    <a class="btn btn-warning pull-left" href="<?= Yii::$app->urlManager->createUrl('doanhnghiep/update') . '?id=' . $model['doanhnghiep']->id_hkd ?>">Cập nhật</a>
</div>