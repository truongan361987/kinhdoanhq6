...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <span class="active">Cập nhật Cửa hàng</span>
    </li>
</ul>
    ...
    <div class="col-lg-12">
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    <span class="font-blue-steel">Cập nhật Cửa hàng</span>
                </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6" no-padding-side>
                                    ...
                                    $form->field($model['cuahang'], 'ma_nganh')->widget(Select2::classname(), [
                                           'initValueText' => $model['cuahang']->ma_nganh,
...
//
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-4">
                                    <?= $form->field($model['cuahang'], 'ten_phuong')->dropDownList(ArrayHelper::map($model['ranhphuong'], 'tenphuong', 'tenphuong'),['prompt' => 'Chọn tên phường'])->label('Tên phường') ?>
                                </div>
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-danger pull-left"
                       href="<?= Yii::$app->urlManager->createUrl('cuahang/view') . '?id=' . $model['cuahang']['id_cuahang'] ?>">Huỷ</a>
...
<script>
    ...
    map.addLayer(marker);
    marker.bindPopup('<?= $model['cuahang']->ten_cuahang ?>');
</script>