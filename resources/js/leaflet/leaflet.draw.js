    ...
    L.drawLocal = {
        draw: {
            toolbar: {
                ...
                buttons: {
                    polyline: 'Vẽ một vùng',
                    polygon: 'Draw a polygon',
                    rectangle: 'Vẽ hình chữ nhật',
                    circle: 'Kiểm tra điều kiện',
            ...
            handlers: {
                circle: {
                    tooltip: {
                        start: 'Chọn và kéo một hình tròn.'
                    },
                    radius: 'Bán kính'
                },
                marker: {
                ...
                polygon: {
                    tooltip: {
                        start: 'Chọn vào bản đồ để bắt đầu vẽ.',
                        cont: 'Chọn để tiếp tục.',
                        end: 'Chọn vào điểm đầu để kết thúc.'
                    }
                },
                polyline: {
        ...
        edit: {
            ...
            handlers: {
                edit: {
                    tooltip: {
                        text: 'Di chuyển marker để thay đổi bán kính',
                        subtext: 'Huỷ bằng cách bấm nút Thoát'
                      
                    },
                },
                remove: {
                    tooltip: {
                        text: 'Chọn vào hình để xóa'
                    }
                }
            }
        }
